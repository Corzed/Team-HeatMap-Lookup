...
public class FRCRobot {
    ...
    private String eventKey; //Event key for organizing output data
    private List<String> positionHistory; //Stores position data for CSV output

    public FRCRobot(Point pos, String team, String eventKey){
        this.pos = pos;
        this.team = team;
    ...
    public void writeData(){
        ...
        File dataDir = new File("data" + File.separator + eventKey);
        if (!dataDir.exists()) {
            dataDir.mkdirs();
        }
